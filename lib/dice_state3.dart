...
class DiceRoller3 extends StatefulWidget {
  ...
  const DiceRoller3({Key? key, required this.diceModel}) : super(key: key);

  @override
  _DiceRollerState3 createState() => _DiceRollerState3();
}

class _DiceRollerState3 extends State<DiceRoller3>
                ...
                Row(
                  ...
                  children: [
                    RotationTransition(
                      turns: _animation,
                      child: Image.asset(
                        "lib/assets/images/dice-$dice1Value.png",
                        width: 150,
                        height: 150,
                      ),
                    ),
