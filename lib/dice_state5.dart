...
class DiceRoller5 extends StatefulWidget {
  final DiceModel diceModel;
  const DiceRoller5({Key? key, required this.diceModel}) : super(key: key);

  @override
  _DiceRollerState5 createState() => _DiceRollerState5();
}

class _DiceRollerState5 extends State<DiceRoller5>
                ...
                Row(
                  ...
                  children: [
                    RotationTransition(
                      turns: _animation,
                      child: Image.asset(
                        "lib/assets/images/dice-$dice2Value.png", // Generate a random number for the dice image
                        width: 100,
                        height: 100,
                      ),
                    ),
                    RotationTransition(
                      turns: _animation,
                      child: Image.asset(
                        "lib/assets/images/dice-$dice3Value.png",
                        width: 100,
                        height: 100,
                      ),
                    ),
                ...
                Row(
                  ...
                  children: [
                    RotationTransition(
                      turns: _animation,
                      child: Image.asset(
                        "lib/assets/images/dice-$dice4Value.png", // Generate a random number for the dice image
                        width: 100,
                        height: 100,
                      ),
                    ),
                    RotationTransition(
                      turns: _animation,
                      child: Image.asset(
                        "lib/assets/images/dice-$dice5Value.png",
                        width: 100,
                        height: 100,
                      ),
                    ),
