...
class DiceRoller2 extends StatefulWidget {
  ...
  const DiceRoller2({Key? key, required this.diceModel}) : super(key: key);

  @override
  _DiceRollerState2 createState() => _DiceRollerState2();
}

class _DiceRollerState2 extends State<DiceRoller2>
